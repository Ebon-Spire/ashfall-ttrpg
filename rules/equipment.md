...
ranged_weapons:
  - {name: Pipe Pistol, tier: 1, damage: "1d6", range: "30/60", properties: [unreliable], cost: 75}
  ...
  - {name: Flamethrower, tier: 3, damage: "2d6 fire", range: "15/30 cone", properties: [area, overheat], cost: 1800}
  ...
  - {name: Dart Rifle, tier: 2, damage: "1", range: "60/120", properties: [silent, "delivers payload"], cost: 350}
light_armor:
...
shields:
  ...
  - {name: Hardened Shield, tier: 3, dv_bonus: 2, special: "Reaction: reduce incoming damage by 2", cost: 1000}
...
augmentations:
  ...
  - {name: Dermal Plating, tier: 1, humanity_cost: 1, effect: "+1 DV", cost: 200}
  ...
  - {name: Ghost Protocol, tier: 3, humanity_cost: 3, effect: "Invisible 1 round 1/day", cost: 2500}
  - {name: Bio-Monitor, tier: 3, humanity_cost: 3, effect: "Auto-stabilize, alert allies", cost: 2000}
stims:
...
chems:
  ...
  - {name: RadPurge, tier: 2, effect: "Remove 1 level of radiation sickness", cost: 100}
  - {name: RadBlock, tier: 2, effect: "Advantage on radiation saves for 8 hours", cost: 75}
  - {name: Sedative, tier: 1, effect: "Target unconscious 10 min, Fortitude DC 15 negates", cost: 30}
...
All characters receive free starting equipment from their archetype (see Starting Equipment below), plus **2d6 × 10 credits** for additional purchases. This represents what you've scrounged, earned, or stolen before the campaign begins.
...
**Tier 1 (Basic):**
- Pipe Pistol: 1d6 damage, range 30/60, unreliable (jam on natural 1) — **75 cr**
...
- Dart Rifle: 1 damage, range 60/120, silent, delivers payload — **350 cr**
...
- Flamethrower: 2d6 fire damage, range 15/30 cone, area, overheat — **1,800 cr**
...
- **Slow:** On hit, target's speed is halved until end of their next turn.
- **Delivers payload:** Can fire tranquilizer darts, poison doses, or other injectable consumables.
...
| Tier | Armor | DV Bonus | Special | Cost |
|------|-------|----------|---------|------|
| 1 | Scrap plating | +3 DV | -5 ft speed | 100 cr |
...
| Tier | Armor | DV Bonus | Special | Cost |
|------|-------|----------|---------|------|
| 1 | Welded scrap suit | +5 DV | -10 ft speed, disadvantage Stealth | 150 cr |
| 2 | Riot armor | +7 DV | -5 ft speed | 500 cr |
...
- Scrap Shield (Tier 1): +1 DV, can use reaction to add +2 vs one attack — **50 cr**
- Combat Shield (Tier 2): +2 DV, can use reaction to block projectiles — **250 cr**
- Hardened Shield (Tier 3): +2 DV, reaction: reduce incoming damage by 2 — **1,000 cr**
- Energy Barrier (Tier 4): +3 DV, regenerating shield points — **4,000 cr**
...
| Augment | Effect | Cost |
|---------|--------|------|
| Reflex Booster | +2 Initiative | 150 cr |
| Targeting Computer | +1 to ranged attacks | 200 cr |
| Dermal Plating | +1 DV (doesn't stack with armor) | 200 cr |
| Enhanced Muscles | +2 carrying capacity, +1 to MIG checks | 175 cr |
| Low-Light Optics | See in dim light as bright light | 125 cr |
| Communications Suite | Internal radio, 10-mile range | 100 cr |

### Tier 2 Augments (Humanity Cost: 2 each)

| Augment | Effect | Cost |
|---------|--------|------|
| Wired Reflexes | +1 action per turn (once per combat) | 750 cr |
| Smart Link | +2 to attack with linked weapons | 600 cr |
| Subdermal Armor | +2 DV, doesn't stack with heavy armor | 700 cr |
| Cybernetic Limb | Replace limb, +3 MIG for that limb, can install weapon mount | 800 cr |
| Neural Processor | +2 INT for technical skills | 650 cr |
| Toxin Filters | Advantage on saves vs poison and disease | 500 cr |

### Tier 3 Augments (Humanity Cost: 3 each)

| Augment | Effect | Cost |
|---------|--------|------|
| Sandevistan Implant | Once per short rest, gain double actions for 1 round | 3,000 cr |
| Mantis Blades | Retractable arm blades (2d6 damage, concealed) | 2,500 cr |
| Ballistic Coprocessor | Reroll missed ranged attacks once per round | 2,800 cr |
| Synthetic Heart | Immune to critical hits, +10 HP | 3,500 cr |
| Ghost Protocol | Turn invisible for 6 seconds (1 round), 1/day | 2,500 cr |
| Bio-Monitor | Auto-stabilize when dying, alert allies to injuries | 2,000 cr |
...
| Sedative | 1 | Target unconscious 10 min, Fortitude DC 15 negates | 30 cr |
...
| RadPurge | 2 | Remove 1 level of radiation sickness | 100 cr |
| Detox | 3 | Cure one addiction | 500 cr |

### Addiction Rules

When a chem specifies "Fortitude DC X or addicted," the character must make a Fortitude save after the chem's effects end. On a failure, the character becomes **addicted** to that substance.

- **Addicted characters** must use the chem at least once every 24 hours or suffer **disadvantage on all ability checks** until they do.
- **Curing addiction** requires either a dose of Detox (500 cr) or **1 week of complete abstinence** followed by a Fortitude DC 18 check at the end of the week. On a failure, the addiction persists and the week must be attempted again.
