...
![A reptilian navigator charts a course through treacherous wasteland terrain](/images/illustrations/reptilian-navigator.png)
...
**Spell References:** The table references "Regeneration" and high-level healing spells by minimum spell level. These are available to Mystics, Channelers, or characters with access to the appropriate spell level through the modular spell crafting system (see Magic). "Regeneration" refers to any healing spell crafted with the *Restore* effect modifier at the listed spell level — GMs should use the spell crafting rules to determine exact cost and casting requirements.
...
- **High Altitude:** Fortitude save DC 16 per day or gain 1 level
...
- **Forage (WIS):** Search for food, water, and useful plants. WIS (Survival) check with DC and yield based on terrain:
  - *Temperate (DC 12):* 1d4 rations on success
  - *Wasteland (DC 16):* 1d3 rations on success
  - *Desolate (DC 20):* 1d2 rations on success
  - *Any terrain:* Success by 5+ yields an extra 1d2 rations (or identifies medicinal herbs instead).
...
- **Map the Route (INT):** Create a detailed map of the area. INT check DC 12. Success grants advantage on future Navigation checks in this area and reveals points of interest.
...
- **Materials:** Raw materials at the cost listed in the [Equipment](equipment.md) crafting table (Tier 1: 5 cr, Tier 2: 25 cr, Tier 3: 100 cr, Tier 4: 500 cr, Tier 5+: 2,000+ cr)
...
- **Technicians:** Reduce jury-rig DC by 2 (their Jury-Rig class feature)
