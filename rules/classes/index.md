...
At Level 11, you transcend your archetype by selecting a **Mastery Path** — a cross-archetype progression representing legendary techniques, organizations, or philosophies. Mastery Paths have both mechanical and narrative prerequisites:

- **Attribute thresholds** (e.g., MIG 15+ and END 14+)
...
Examples include **Arsenal** (perfect weapon mastery), **Voidwalker** (reality manipulation), **Iron Sigil** (technomantic fusion), or **Lifebringer** (cheat mortality itself). Mastery Paths grant abilities at L11, L13, and L15, culminating in a transformative capstone.
...
![A mystic channels raw arcane power while a channeler communes with the spirit world — the wasteland breeds many paths to power](/images/illustrations/mystic-casting.png)
