...
export const rulesNav: NavSection[] = [
  {
    ...
    links: [
      ...
      { label: 'Chassis', slug: 'chassis', description: 'Your starting frame — HP, proficiencies, and equipment packages.' },
      { label: 'Character Points', slug: 'character-points', description: 'CP economy, skill tree costs, and anti-convergence mechanics.' },
      { label: 'Skill Trees', slug: 'skill-trees', description: '11 shared skill trees — abilities, prerequisites, and rebuild guides.' },
  ...
  },
  {
    ...
    links: [
      { label: 'Build Overview', slug: 'classes', description: 'Overview of all 12 recommended builds and the classless system.' },
      ...
      { label: 'Mystic', slug: 'classes/mystic', description: 'AOE Mage/Control (d6). Glass cannon, big spells.' },
      ...
      { label: 'Operative', slug: 'classes/operative', description: 'Skill/Burst Damage (d6). Stealth, burst damage, utility.' },
      { label: 'Diplomat', slug: 'classes/diplomat', description: 'Buffer/Social (d8). Empower allies, control the field.' },
      { label: 'Channeler', slug: 'classes/channeler', description: 'Hybrid Warrior/Mage (d8). Melee + healing.' },
      { label: 'Scavenger', slug: 'classes/scavenger', description: 'Resourceful Generalist (d8). Improvise, adapt, overcome.' },
      { label: 'Infiltrator', slug: 'classes/infiltrator', description: 'Intelligence/Tactical Support (d8). Information is power.' },
      { label: 'Psion', slug: 'classes/psion', description: 'Controller/Damage (d6). Bend minds and reality.' },
      { label: 'Mutant', slug: 'classes/mutant', description: 'Adaptive Striker/Bruiser (d10). Evolve in the field.' },
    ],
  },
  {
    title: 'Progression',
    links: [
      { label: 'Character Progression', slug: 'progression', description: 'Level-by-level gains, doctrines, and CP spending.' },
      { label: 'Talents', slug: 'talents', description: 'Universal, build, and legendary talents.' },
      { label: 'Mastery Paths', slug: 'mastery-paths', description: '15 cross-build mastery paths for levels 11-15.' },
      { label: 'Multiclassing', slug: 'multiclassing', description: 'Requirements, CP distribution, and examples.' },
      { label: 'Cross-Training', slug: 'cross-training', description: 'Learn abilities from other builds without multiclassing.' },
    ],
  },
  {
